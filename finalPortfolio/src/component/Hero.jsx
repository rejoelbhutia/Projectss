...
/>
        ...
        <div className='details-con flex flex-col gap-y-2'>
            ...
            <div className="button-con flex  md:flex-row space-x-4 justify-center">
                <button className=' w-32 h-14 border rounded-full font-bold p-4 text-sm hover:bg-neutral-800 hover:text-white' onClick={downloadFile}>Download CV</button>
                <button className=' w-32 h-14 border rounded-full p-4 text-sm font-bold bg-neutral-800 text-white hover:bg-neutral-950' onClick={() => {
                    location.href="#contact"
                }}>Contact Info</button>
            </div>
            <div className="social-container flex items-center justify-center">
                <img src={gitHubIcon} alt="gitHubIcon" className=' h-10 cursor-pointer' onClick={()=>{
                    window.open("https://github.com/rejoelbhutia", "_target")
                }} />
